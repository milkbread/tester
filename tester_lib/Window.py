...
# This class is meant to be subclassed by TesterWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        """
        builder = get_builder('TesterWindow')
        new_object = builder.get_object("tester_window")
    ...
    def finish_initializing(self, builder):
        ...
        self.settings = Gio.Settings("net.launchpad.tester")
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('tester')
        except ImportError:
            pass
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for tester."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for tester."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the TesterWindow."""
        print "Closing1"
        self.destroy()
