...
class PreferencesDialog(Gtk.Dialog):
    ...
    def __new__(cls):
        ...
        """
        builder = get_builder('PreferencesTesterDialog')
        new_object = builder.get_object("preferences_tester_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        finish initializing the start of the new PerferencesTesterDialog
        instance.
